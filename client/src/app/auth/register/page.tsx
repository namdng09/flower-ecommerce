        ...
        <form className="w-full" action="#" method="POST">
          <div className="flex flex-row gap-8">
            ...
            <div className="flex-1 space-y-6">
              <div>
                <label className="text-sm font-bold text-gray-700 tracking-wide">Họ tên</label>
                <input
              ...
              <div>
                <label className="text-sm font-bold text-gray-700 tracking-wide">Tài khoản đăng nhập</label>
                <input
                  className="w-full text-base py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500"
                  type="text"
            ...
            <div className="flex-1 space-y-6">
              <div>
                <label className="text-sm font-bold text-gray-700 tracking-wide">Số điện thoại</label>
                <input
                  className="w-full text-base py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500"
                  type="tel"
              ...
              <div>
                <label className="text-sm font-bold text-gray-700 tracking-wide">Mật khẩu</label>
                <input
                  className="w-full text-base py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500"
              ...
              <div>
                <label className="text-sm font-bold text-gray-700 tracking-wide">Xác nhận mật khẩu</label>
                <input
                  className="w-full text-base py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500"
