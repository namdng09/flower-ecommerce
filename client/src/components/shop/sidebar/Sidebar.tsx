...
const Sidebar = () => {
    ...
    return (
        <aside className="w-64 min-h-screen bg-white border-r px-4 py-6">
            ...
            {/* MAIN MENU */}
            <div className="mb-6">
                <p className="text-[11px] font-semibold text-gray-400 uppercase mb-3 px-2 tracking-wide">Main Menu</p>
            ...
            {/* COMPONENTS */}
            <div className="mb-6">
                <p className="text-[11px] font-semibold text-gray-400 uppercase mb-3 px-2 tracking-wide">Components</p>
                <nav className="space-y-1">
            ...
            {/* CRAFTED */}
            <div>
                <p className="text-[11px] font-semibold text-gray-400 uppercase mb-3 px-2 tracking-wide">Crafted</p>
                <nav className="space-y-1">
                    <NavLink to="#" className={linkClass}>
                        {indicator}
                        <FiFileText size={16} />
