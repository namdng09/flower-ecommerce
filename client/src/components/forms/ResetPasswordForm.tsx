...
import { type ResetPasswordFormFields, resetPasswordSchema } from '~/types/resetPassword';
...
const ResetPasswordForm: React.FC = () => {
    ...
    const onSubmit = async (data: ResetPasswordFormFields) => {
        try {
            ...
            alert('Đã gửi email xác nhận đặt lại mật khẩu. Vui lòng kiểm tra hộp thư của bạn.');
        }
    };
