    ...
    <div className='flex flex-col md:flex-row items-center justify-between max-w-6xl mx-auto p-8 min-h-screen bg-white text-gray-800'>
      <div className='md:w-1/2 space-y-6'>
        ...
        <p className='font-semibold'>
          Phuler Shop is a premium HTML template designed and developed from the
          ground up with the sole purpose of helping you create an astonishing,
          the beautiful and user friendly website that will boost your product’s
          sales.
        </p>
        <p>
          The theme design package provides a complete Magento theme set for
          your online store according to your desired theme. This includes all
          Magento themes that are required for your online store’s successful
          implementation.
        </p>
