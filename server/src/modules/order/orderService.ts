import OrderModel, { ICustomization, IOrder, IOrderItem, IPayment, IShipment } from './orderModel';
...
export const orderService = {
    ...
    create: async (orderData: IOrder) => {
        const { user, address, items, payment, shipment, customization } = orderData;
